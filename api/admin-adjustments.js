  ...
  try{
    ...
    if(action==='create'){
      ...
      const created=await sb('plan_adjustments',{
        ...
        body:[{telegram_id:telegramId,adjustment_type:'nutrition',old_kcal:oldKcal,new_kcal:newKcal,trainer_comment:trainerComment,effective_from:effectiveFrom}]
      });
      ...
      return json(res,200,{adjustment:Array.isArray(created)?created[0]:null,profile:updated[0]});
    }
